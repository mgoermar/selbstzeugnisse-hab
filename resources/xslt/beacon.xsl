...
<xsl:stylesheet xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:mets="http://www.loc.gov/METS/"
    ...
    <xsl:template match="/">
        <xsl:result-document href="sz2_beacon.txt">
            <xsl:text>#FORMAT: BEACON&#13;#PREFIX: http://d-nb.info/gnd/&#13;#INSTITUTION: Herzog August Bibliothek Wolfenb&#xFC;ttel&#13;#NAME: Personenregister "Selbstzeugnisse der Frühen Neuzeit in der Herzog August Bibliothek II"&#13;#FEED: http://selbstzeugnisse.hab.de/sz2_beacon.txt&#13;#TARGET: http://selbstzeugnisse.hab.de/sz2/personen#{ID}&#13;#TIMESTAMP: </xsl:text><xsl:value-of select="current-date()"/><xsl:text>&#13;</xsl:text>
            <xsl:for-each select="//tei:person[tei:persName[contains(@ref,'gnd')]]">
                <xsl:value-of select="tei:persName/@ref/normalize-space(substring-after(.,'gnd/'))"/>
                <xsl:text>||</xsl:text>

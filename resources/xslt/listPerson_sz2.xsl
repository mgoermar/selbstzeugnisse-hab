...
<xsl:stylesheet exclude-result-prefixes="tei mets html map"
    ...
    <xsl:import href="default.xsl"/>
        ...
        <xsl:variable name="currentFile" select="document('../daten/sz2/register/listPerson_s2.xml')"/>
    ...
    <xsl:template match="tei:persName[@type='display']">
        ...
        <table>
            <tbody>
                <xsl:if test="$cod_guelf_28_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                    <tr>
                        <td><h4>Cod. Guelf. 28 Blank.:</h4></td>
                        <td>
                            <xsl:for-each select="$cod_guelf_28_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                ...
                <xsl:if test="$cod_guelf_211_1_extrav_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                    <tr>
                        <td><h4>Cod. Guelf. 211,1 Extrav.:</h4></td>
                        <td>
                            <xsl:for-each select="$cod_guelf_211_1_extrav_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                ...
                <xsl:if test="$cod_guelf_286_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                    <tr>
                        <td><h4>Cod. Guelf. 286 Blank.:</h4></td>
                        <td>
                            <xsl:for-each select="$cod_guelf_286_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                ...
                <xsl:if test="$cod_guelf_286a_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
                    <tr>
                        <td><h4>Cod. Guelf. 286a Blank.:</h4></td>
                        <td>
                            <xsl:for-each select="$cod_guelf_286a_blank_Data//tei:rs[@type='person'][not(contains(@ref,' '))][substring-after(@ref,'#')=current()/parent::tei:person/@xml:id]">
